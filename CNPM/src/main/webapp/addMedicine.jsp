    ...
    <div class="container mt-5">
        ...
        <form action="AddMedicine" >
            <div class="form-group">
                <label for="nameMe">Medicine's Name</label>
                <input type="text" class="form-control" id="nameMe" name="nameMe" required>
            </div>
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="doseMin">Medicine's Dose Min</label>
                    <input type="text" class="form-control" id="doseMin" name="doseMin" required>
                </div>
                <div class="form-group col-md-6">
                    <label for="doseMax">Medicine's Dose Max</label>
                    <input type="text" class="form-control" id="doseMax" name="doseMax" required>
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="frequencyMin">Medicine's Frequency Min</label>
                    <input type="text" class="form-control" id="frequencyMin" name="frequencyMin" required>
                </div>
                <div class="form-group col-md-6">
                    <label for="frequencyMax">Medicine's Frequency Max</label>
                    <input type="text" class="form-control" id="frequencyMax" name="frequencyMax" required>
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="daydoseMin">Medicine's Day Dose Min</label>
                    <input type="text" class="form-control" id="daydoseMin" name="daydoseMin" required>
                </div>
                <div class="form-group col-md-6">
                    <label for="daydoseMax">Medicine's Day Dose Max</label>
                    <input type="text" class="form-control" id="daydoseMax" name="daydoseMax" required>
                </div>
            </div>
            
            <button type="button" onclick = "location.href='/CNPM/Medicine'" class="btn  btn-outline-success">Back</button>
            <button type="submit" class="btn btn-primary  btn-success"  onclick="moreInfo()"> Add Medicine</button>
        </form>
    </div>
